...
class Vector {
    ...
    static randomGaussian2D(min: number, max: number, skew: number = 1): Vector{
        const vec = new Vector(0, 0);
    ...
    static randomGaussian3D(min: number, max: number, skew: number = 1): Vector{
        const vec = new Vector(0, 0, 0);
        vec.x = Vector.randn_bm(min, max, skew);
        vec.y = Vector.randn_bm(min, max, skew);
     ...
     * @returns 
     */
    static randn_bm(min: number, max: number, skew: number = 1) {
        let u = 0, v = 0;
